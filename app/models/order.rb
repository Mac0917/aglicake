class Order < ApplicationRecord
  ...
  validates :delivery_address, presence: true,  presence: { message: "を入力してください" }
  validates :delivery_name, presence: true, format: { with: /\A[一-龥ぁ-ん]/, message: "を漢字またはひらがなで入力してください" }
